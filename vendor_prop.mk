PRODUCT_PROPERTY_OVERRIDES +=  \
    ...
    ro.bd_uaprofile_url=uaprofile \
    ro.bt.bdaddr_path=/data/misc/bluedroid/btmac.txt \
    ro.btwifisoftap.coexist=true \
    ro.build.code_version=222d3e880f07cefbdf1108b136603e07168c64e1 \
    ro.carrier=unknown \
    ...
    ro.config.default_message0=Titan.ogg \
    ro.config.default_message1=Titan.ogg \
    ro.config.default_message=Titan.ogg \
    ro.config.low_ram=true \
    ro.config.notification_sound=Titan.ogg \
    ro.config.ringtone0=Callisto.ogg \
    ro.config.ringtone1=Phobos.ogg \
    ro.config.ringtone=Callisto.ogg \
    ro.control_privapp_permissions=log \
    ro.ge2.mode=gps_beidou \
    ro.hardware.keystore=sprdtrusty \
    ro.hotspot.enabled=1 \
    ro.keybox.id.value=SP630 \
